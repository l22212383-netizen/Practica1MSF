...
#plot(t,Pao,'-',t,PA1,'--o',t,PA2,'--+',t,PA3,'--x',t,PA4,'--d',t,PID,':',
...
_,pid = ctrl.forced_response(sysPID,t,u1,x0)
plt.plot(t,pid,':',linewidth = 4, color = clr6, label = 'PID(t)') #Respuesta en lazo cerrado
...
_,pid = ctrl.forced_response(sysPID,t,u3,x0)
plt.plot(t,pid,':',linewidth = 4, color = clr6, label = 'PID(t)') #Respuesta en lazo cerrado
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(0,1.1); plt.yticks(np.arange(0,1.2,0.1))
plt.xlabel('t[s]',fontsize = 11)
...
_,pid = ctrl.forced_response(sysPID,t,u4,x0)
plt.plot(t,pid,':',linewidth = 4, color = clr6, label = 'PID(t)') #Respuesta en lazo cerrado
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
